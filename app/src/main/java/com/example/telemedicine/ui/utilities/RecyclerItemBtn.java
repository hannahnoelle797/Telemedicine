...
public class RecyclerItemBtn extends RecyclerView.Adapter<RecyclerItemBtn.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View v,OnReportClickListener reportClickListener) {
            super(v);
            button = v.findViewById(R.id.recycler_item_btn);
    ...
    public RecyclerItemBtn(String[] myDataset, OnReportClickListener onReportClickListener) {
        mDataset = myDataset;
    ...
    @Override
    public RecyclerItemBtn.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
