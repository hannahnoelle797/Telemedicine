...
public class RecyclerItemBtnDelete extends RecyclerView.Adapter<RecyclerItemBtnDelete.MyViewHolder> {
    private String[] data;
    ...
    public RecyclerItemBtnDelete(String[] dataset, OnReportClickListener rclIO){
        data = dataset;
        this.rcl = rclIO;
    }

    public RecyclerItemBtnDelete.MyViewHolder onCreateViewHolder(ViewGroup parent, int view){
